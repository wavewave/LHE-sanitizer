...
tar cvzf LHE-sanitizer.tar.gz $HOME/.cabal/share/doc/LHE* $HOME/.cabal/share/doc/HEPUtil*  $HOME/.cabal/share/doc/LHCOAnalysis*
echo $CR | curl --digest -T LHE-sanitizer.tar.gz -K - $SRVRURL 
